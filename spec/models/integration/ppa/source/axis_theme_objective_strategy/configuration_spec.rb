...
RSpec.describe Integration::PPA::Source::AxisThemeObjectiveStrategy::Configuration, type: :model do
  subject(:configuration) { build(:integration_ppa_source_axis_theme_objective_strategy_configuration) }

  describe 'factories' do
    it { is_expected.to be_valid }

    it { expect(build(:integration_ppa_source_axis_theme_objective_strategy_configuration, :invalid)).to be_invalid }
  end
