...
describe Integration::PPA::Source::Region::Configuration do
  subject(:configuration) { build(:integration_ppa_source_region_configuration) }

  describe 'factories' do
    it { is_expected.to be_valid }

    it { expect(build(:integration_ppa_source_region_configuration, :invalid)).to be_invalid }
  end
