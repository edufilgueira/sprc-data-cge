...
RSpec.describe Integration::PPA::Source::AxisTheme::Configuration, type: :model do
  subject(:configuration) { build(:integration_ppa_source_axis_theme_configuration) }

  describe 'factories' do
    it { is_expected.to be_valid }

    it { expect(build(:integration_ppa_source_axis_theme_configuration, :invalid)).to be_invalid }
  end
