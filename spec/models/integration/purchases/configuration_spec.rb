...
describe Integration::Purchases::Configuration do

  subject(:configuration) { build(:integration_purchases_configuration) }

  describe 'factories' do
    it { is_expected.to be_valid }

    it { expect(build(:integration_purchases_configuration, :invalid)).to be_invalid }
  end
  ...
  describe 'helpers' do
    ...
    it 'import' do
      ...
      expect(Integration::Purchases::Importer).to receive(:delay) { importer }
