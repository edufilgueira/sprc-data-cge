...
describe Integration::Supports::Domain::Configuration do

  subject(:configuration) { build(:integration_supports_domain_configuration) }

  describe 'factories' do
    it { is_expected.to be_valid }

    it { expect(build(:integration_supports_domain_configuration, :invalid)).to be_invalid }
  end
  ...
  describe 'helpers' do
    ...
    it 'import' do
      ...
      expect(Integration::Supports::Domain::Importer).to receive(:delay) { importer }
