...
describe Integration::Supports::Axis::Configuration do
  subject(:configuration) { build(:integration_supports_axis_configuration) }

  describe 'factories' do
    it { is_expected.to be_valid }

    it { expect(build(:integration_supports_axis_configuration, :invalid)).to be_invalid }
  end
