FactoryBot.define do
  factory :integration_expenses_consortium_transfer, class: 'Integration::Expenses::ConsortiumTransfer' do
    exercicio "2017"
    sequence(:unidade_gestora) { |n| "10102#{n}" }
