FactoryBot.define do
  factory :integration_expenses_non_profit_transfer, class: 'Integration::Expenses::NonProfitTransfer' do
    exercicio "2017"
    sequence(:unidade_gestora) { |n| "80#{n}1" }
