FactoryBot.define do
  factory :integration_expenses_multi_gov_transfer, class: 'Integration::Expenses::MultiGovTransfer' do
    exercicio "2017"
    sequence(:unidade_gestora) { |n| "50#{n}1" }
