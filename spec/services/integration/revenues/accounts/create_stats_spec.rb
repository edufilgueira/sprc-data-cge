...
describe Integration::Revenues::Accounts::CreateStats do
  ...
  describe 'totals' do
    ...
    let(:other_previsao_inicial_attributes) do
      previsao_inicial_attributes.merge({conta_contabil: '5.2.1.1.1'})
    end
    ...
    describe 'data' do
      ...
      describe 'total' do
        it 'valor_previsto_inicial' do
          ...
          expected_value = (100) + (200 - 50)
          expect_count = 1

          Integration::Revenues::Accounts::CreateStats.call(year, month, month_range)

          generated = Stats::Revenues::Account.find_by(year: year, month_start: month_start, month_end: month_end).data[:total]

          expect(generated[:valor_previsto_inicial]).to eq(expected_value)
          expect(generated[:count]).to eq(expect_count)
        end

        it 'valor_previsto_inicial with more than one revenues' do
          previsao_inicial_revenue
          other_previsao_inicial_revenue

          out_of_range_previsao_inicial_revenue

          expected_value = ((100) + (200 - 50)) * 2
          expect_count = 2
        ...
        describe 'valor_previsto_atualizado' do
          ...
          let(:previsao_receita_adicional_attributes) do
            {
              # Previsão receita adicional vem das contas '5.2.1.2.1' (Previsão de Receita Adicional)

              organ: organ,
              poder: 'EXECUTIVO',
              unidade: organ.codigo_orgao,
              conta_contabil: '5.2.1.2.1',
              natureza_da_conta: 'CRÉDITO',
              valor_inicial: 100,
              valor_credito: 200,
              valor_debito: 50,
      ...
      describe 'secretary' do
        it 'valor_previsto_inicial' do
          ...
          generated = Stats::Revenues::Account.find_by(year: year, month_start: month_start, month_end: month_end).data[:secretary]
      ...
      describe 'consolidado' do # Tipo de receita
        let(:first_revenue_nature_subalinea) { create(:integration_supports_revenue_nature, codigo: '112109953')}
        let(:first_revenue_nature_consolidado) { create(:integration_supports_revenue_nature, codigo: '100000000')}

        let(:second_revenue_nature_subalinea) { create(:integration_supports_revenue_nature, codigo: '813250199')}
        let(:second_revenue_nature_consolidado) { create(:integration_supports_revenue_nature, codigo: '800000000')}
        ...
        it 'valor_previsto_inicial' do
          first_revenue_nature_consolidado
          second_revenue_nature_consolidado

          previsao_inicial_revenue

          Integration::Revenues::Accounts::CreateStats.call(year, month, month_range)

          generated = Stats::Revenues::Account.find_by(year: year, month_start: month_start, month_end: month_end).data[:consolidado]

          expect(generated.keys).to eq([first_revenue_nature_consolidado.title, second_revenue_nature_consolidado.title])
      ...
      describe 'categoria_economica' do
        let(:first_revenue_nature_subalinea) { create(:integration_supports_revenue_nature, codigo: '112109953')}
        let(:first_revenue_nature_categoria_economica) { create(:integration_supports_revenue_nature, codigo: '110000000')}

        let(:second_revenue_nature_subalinea) { create(:integration_supports_revenue_nature, codigo: '813250199')}
        let(:second_revenue_nature_categoria_economica) { create(:integration_supports_revenue_nature, codigo: '810000000')}
        ...
        it 'valor_previsto_inicial' do
          first_revenue_nature_categoria_economica
          second_revenue_nature_categoria_economica

          previsao_inicial_revenue

          Integration::Revenues::Accounts::CreateStats.call(year, month, month_range)

          generated = Stats::Revenues::Account.find_by(year: year, month_start: month_start, month_end: month_end).data[:categoria_economica]

          expect(generated.keys).to eq([first_revenue_nature_categoria_economica.title, second_revenue_nature_categoria_economica.title])
      ...
      describe 'origem' do
        let(:first_revenue_nature_subalinea) { create(:integration_supports_revenue_nature, codigo: '112109953')}
        let(:first_revenue_nature_origem) { create(:integration_supports_revenue_nature, codigo: '112000000')}

        let(:second_revenue_nature_subalinea) { create(:integration_supports_revenue_nature, codigo: '813250199')}
        let(:second_revenue_nature_origem) { create(:integration_supports_revenue_nature, codigo: '813000000')}
        ...
        it 'valor_previsto_inicial' do
          first_revenue_nature_origem
          second_revenue_nature_origem

          previsao_inicial_revenue

          Integration::Revenues::Accounts::CreateStats.call(year, month, month_range)

          generated = Stats::Revenues::Account.find_by(year: year, month_start: month_start, month_end: month_end).data[:origem]

          expect(generated.keys).to eq([first_revenue_nature_origem.title, second_revenue_nature_origem.title])
      ...
      describe 'origem' do
        ...
        it 'valor_previsto_inicial' do
          ...
          generated = Stats::Revenues::Account.find_by(month_start: month_start, month_end: month_end, year: year).data[:subfonte]

          expect(generated.keys).to eq([first_revenue_nature_subfonte.title, second_revenue_nature_subfonte.title])
